...
/*!
 * \brief Modeluje polecenie dla robota mobilnego, które wymusza pauzę
 *
 *  Klasa modelująca polecenie pauzy robota.
 */
class Interp4Pause: public AbstractInterp4Command {
  /*
   *  Tu należy zdefiniować pola, które są niezbędne
   *  do przechowywania wartości parametrów danego polecenia.
   *  Poniżej zdefiniowane jest tylko jedno pole jako przykład.
   */
  double  _Duration_ms;  // Czas pauzy w milisekundach
 public:
  /*!
   * \brief
   */
